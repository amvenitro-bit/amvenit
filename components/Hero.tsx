...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      {/* Wrapper: 100svh + safe-area => stabil pe iPhone */}
      <div className="min-h-[100svh] px-6 pt-[calc(env(safe-area-inset-top)+24px)] pb-[calc(env(safe-area-inset-bottom)+22px)] flex items-center justify-center">
        {/* MASCOTĂ – telefon */}
        <div className="absolute left-3 top-[calc(env(safe-area-inset-top)+12px)] z-20 md:hidden">
          <Image
            src="/mascota.png"
        ...
        {/* DREAPTA SUS */}
        <div className="absolute top-[calc(env(safe-area-inset-top)+18px)] right-6 z-30">
          {/* Desktop */}
        ...
        {/* CONTENT pe 3 zone (sus / mijloc / jos) */}
        <div className="w-full max-w-2xl text-center flex flex-col min-h-[100svh] pt-2">
          {/* ZONA SUS */}
          <div className="flex-none">
            {/* Titlu mare doar pe desktop și doar la livrator */}
            {isCourier && (
              <h1 className="hidden md:block text-5xl md:text-6xl font-extrabold text-white">
                amvenit.ro
              </h1>
            )}
          ...
          <div className="flex-1 flex flex-col justify-center">
            {!roleReady && isLoggedIn ? null : isCourier ? (
              <>
                ...
                <div className="mt-6 flex flex-col gap-4 items-center">
                  ...
                  {/* PASUL 2: pe mobil brand mic sub butoane */}
                  <div className="md:hidden pt-4">
                    <div className="text-white/85 font-extrabold text-xl">
                      amvenit.ro
                    </div>
                  </div>
                </div>
              ...
              <>
                {/* pentru client/anon -> coborâm titlul pe mobil ca să nu intre în mascotă */}
          ...
          {/* ZONA JOS (fix) */}
          <div className="flex-none">
            <div className="mt-8 md:mt-12 flex flex-row items-center justify-center gap-4 sm:gap-6">
