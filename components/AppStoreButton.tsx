...
const AppStoreButton = ({ dark }: { dark?: boolean }) => {
  ...
  // IMPORTANT:
  // dark=true -> buton alb cu text negru (se vede bine pe fundal dark)
  // dark=false -> buton dark cu text alb (se vede bine pe fundal deschis)
  const classes = clsx(
    base,
    dark
  ...
  return (
    <a href={ctaDetails.appStoreUrl} target="_blank" rel="noreferrer">
