...
const PlayStoreButton = () => {
  return (
    <a href={ctaDetails.googlePlayUrl} className="inline-block">
      <button
        type="button"
        className={clsx(
          "flex items-center justify-center rounded-full h-12 sm:h-14 " +
            ...
            "px-4 sm:px-6 " +
            "w-auto " +
            // ✅ FIX: mereu vizibil pe dark/light
            "bg-slate-900 text-white border border-white/10 hover:bg-slate-800 transition"
        )}
      >
